...
export function loadStartupLayout(env: Record<string, string | undefined>) {
  ...
  const businessMigrationSql = [
    ...
    readFileSync(paths.conversationAvatarsMigration, "utf8"),
    readFileSync(paths.qqConversationSummariesMigration, "utf8"),
    readFileSync(paths.qqContextCompressionMigration, "utf8"),
    readFileSync(paths.qqContextLimitCapsMigration, "utf8"),
  ] as const;
