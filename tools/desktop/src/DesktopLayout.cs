...
namespace Superstring.Desktop
{
    internal sealed class DesktopLayout
    {
        ...
        public void ValidateInstalledResources()
        {
            ...
            RequireInteger(manifest, "businessSchemaVersion", 42);
